...
(function () {
  ...
  const DICT = {
    ru: {
      ...
      duelInvite: 'Предлагаю сыграть в NEON://SNAKE!',
      duelInviteBtn: 'ПОЗВАТЬ В БОЙ',
      duelCopy: 'КОПИРОВАТЬ ССЫЛКУ',
      duelCopied: 'СКОПИРОВАНО',
      duelGo: 'В БОЙ',
      duelYouAre: 'ВЫ — СИНЯЯ ЗМЕЙКА',
      duelYouAreHost: 'ВЫ — СИНЯЯ · СОПЕРНИК — ОРАНЖЕВАЯ',
      duelYou: 'ВЫ',
      duelHost: 'ХОСТ',
      duelGuest: 'ГОСТЬ',
      duelRematch: 'РЕВАНШ',
      ...
      duelErrNoNet: 'НЕТ СВЯЗИ. Закройте и откройте игру 2 раза — придёт обновление',
      ...
      lobbyTitle: 'ЖДУТ ИГРОКИ',
      lobbyEmpty: 'Пока никто не ждёт — создайте бой первым!',
      lobbyJoin: 'ВОЙТИ',
      lobbyAccept: 'ПРИНЯТЬ БОЙ',
      lobbyRivalFound: 'СОПЕРНИК НАШЁЛСЯ — БОЙ НАЧИНАЕТСЯ!',
      questsTitle: 'ЗАДАНИЯ',
      pvpTopTitle: 'РЕЙТИНГ ПВП',
      pvpStatusesTitle: 'СТАТУСЫ ПВП',
      pvpNoData: 'Сыграйте первый бой, чтобы попасть в рейтинг',
      pvpRating: 'РЕЙТИНГ {1}',
      pvpRecord: 'ПОБЕДЫ: {1} · ПОРАЖЕНИЯ: {2}',
      pvpNoStatus: 'БЕЗ СТАТУСА',
      pvpStatusNew: 'НОВЫЙ СТАТУС: {1}',
      dqWins: 'ПВП-дейлик: выиграй {1} дуэли',
      dqPlay: 'ПВП-дейлик: сыграй {1} дуэли',
      dqBite: 'ПВП-дейлик: {1} раунда-победы укусом',
      dqClean: 'ПВП-дейлик: выиграй бой 2:0',
      dqLoop: 'ПВП-дейлик: победа закольцовкой',
      wqWins: 'Неделя: {1} побед в дуэлях',
      wqDiff: 'Неделя: победы над {1} разными соперниками',
      wqStreak: 'Неделя: серия из {1} побед подряд',
      wqRounds: 'Неделя: {1} выигранных раундов',
      pvpS1: 'Новобранец Сети',
      pvpS2: 'Первая кровь',
      pvpS3: 'Дуэлянт',
      pvpS4: 'Охотник',
      pvpS5: 'Серийный',
      ...
      pvpS15: 'Тактик',
      pvpS16: 'Титан',
      pvpS17: 'Легенда арены',
      pvpS18: 'Идеальная серия',
      pvpS19: 'Пожиратель чемпионов',
      pvpS20: 'Абсолют',
      pvpReq1: 'Сыграть 1 матч ПВП',
      pvpReq2: 'Первая победа в ПВП',
      pvpReq3: 'Сыграть 10 матчей',
      pvpReq4: '10 побед',
      pvpReq5: 'Серия из 3 побед',
      pvpReq6: '5 раундов-побед укусом',
      pvpReq7: '3 победы закольцовкой',
      pvpReq8: 'Сыграть 25 матчей',
      pvpReq9: 'Рейтинг 1200+',
      pvpReq10: '25 побед',
      pvpReq11: '10 побед со счётом 2:0',
      pvpReq12: '5 раз победить сразу после поражения',
      pvpReq13: 'Рейтинг 1400+',
      pvpReq14: '3 победы за один день',
      pvpReq15: '30 выигранных раундов',
      pvpReq16: 'Рейтинг 1600+',
      pvpReq17: '100 побед',
      pvpReq18: 'Серия из 10 побед',
      pvpReq19: 'Победы над 10 разными соперниками',
      pvpReq20: 'Рейтинг 1800+',
      skinCondChrome: 'Статус ПВП «Хромир» (рейтинг 1200)',
      skinCondPlasma: 'Статус ПВП «Неоновый» (рейтинг 1400)',
      skinChrome: 'ХРОМ',
      skinPlasma: 'ПЛАЗМА'
    },
    en: {
      ...
      duelInvite: "Let's play NEON://SNAKE!",
      duelInviteBtn: 'INVITE TO A DUEL',
      duelCopy: 'COPY LINK',
      duelCopied: 'COPIED',
      duelGo: 'FIGHT',
      duelYouAre: 'YOU ARE THE BLUE SNAKE',
      duelYouAreHost: 'YOU ARE BLUE · RIVAL IS ORANGE',
      duelYou: 'YOU',
      duelHost: 'HOST',
      duelGuest: 'GUEST',
      duelRematch: 'REMATCH',
      ...
      duelErrNoNet: 'NO CONNECTION. Close and reopen the game twice to get the update',
      ...
      lobbyTitle: 'PLAYERS WAITING',
      lobbyEmpty: 'Nobody is waiting yet — create a battle first!',
      lobbyJoin: 'JOIN',
      lobbyAccept: 'ACCEPT BATTLE',
      lobbyRivalFound: 'RIVAL FOUND — THE BATTLE BEGINS!',
      questsTitle: 'QUESTS',
      pvpTopTitle: 'PVP RATING',
      pvpStatusesTitle: 'PVP STATUSES',
      pvpNoData: 'Play your first duel to enter the rating',
      pvpRating: 'RATING {1}',
      pvpRecord: 'WINS: {1} · LOSSES: {2}',
      pvpNoStatus: 'NO STATUS',
      pvpStatusNew: 'NEW STATUS: {1}',
      dqWins: 'PVP daily: win {1} duels',
      dqPlay: 'PVP daily: play {1} duels',
      dqBite: 'PVP daily: {1} round-wins by bite',
      dqClean: 'PVP daily: win a duel 2:0',
      dqLoop: 'PVP daily: win by encircling',
      wqWins: 'Week: {1} duel wins',
      wqDiff: 'Week: beat {1} different rivals',
      wqStreak: 'Week: a streak of {1} wins',
      wqRounds: 'Week: {1} rounds won',
      pvpS1: 'Grid Recruit',
      pvpS2: 'First Blood',
      pvpS3: 'Duelist',
      pvpS4: 'Headhunter',
      ...
      pvpS12: 'Avenger',
      pvpS13: 'The Neon',
      pvpS14: 'Night Assault',
      pvpS15: 'Tactician',
      pvpS16: 'Titan',
      pvpS17: 'Arena Legend',
      pvpS18: 'Flawless Series',
      pvpS19: 'Champion Eater',
      pvpS20: 'The Absolute',
      pvpReq1: 'Play 1 PVP match',
      pvpReq2: 'Your first PVP win',
      pvpReq3: 'Play 10 matches',
      pvpReq4: '10 wins',
      pvpReq5: 'A streak of 3 wins',
      pvpReq6: '5 round-wins by bite',
      pvpReq7: '3 wins by encircling',
      pvpReq8: 'Play 25 matches',
      pvpReq9: 'Rating 1200+',
      pvpReq10: '25 wins',
      pvpReq11: '10 clean 2:0 wins',
      pvpReq12: 'Win right after a loss ×5',
      pvpReq13: 'Rating 1400+',
      pvpReq14: '3 wins in one day',
      pvpReq15: '30 rounds won',
      pvpReq16: 'Rating 1600+',
      pvpReq17: '100 wins',
      pvpReq18: 'A streak of 10 wins',
      pvpReq19: 'Beat 10 different rivals',
      pvpReq20: 'Rating 1800+',
      skinCondChrome: 'PVP status Chrome One (rating 1200)',
      skinCondPlasma: 'PVP status The Neon (rating 1400)',
      skinChrome: 'CHROME',
      skinPlasma: 'PLASMA'
    }
  };
