...
(function () {
  ...
  const DICT = {
    ru: {
      ...
      ghostWarn: 'ОХОТНИК!',
      ghostEat: 'ОХОТНИК СЪЕДЕН +{1}',
      ghostEaten: 'ТЕБЯ ПОЖРАЛИ!',
      ...
      lobbyPickHint: 'ВЫБЕРИТЕ ИГРОКА',
      quickBattle: 'БЫСТРЫЙ БОЙ',
      duelFoeFound: 'СОПЕРНИК В КОМНАТЕ!',
      lobbyOnline: 'СЕЙЧАС В ЛОББИ: {1}',
      duelRoomTitle: 'КОМНАТА БОЯ',
      duelLeave: 'ПОКИНУТЬ КОМНАТУ',
      buildLabel: 'СБОРКА {1}',
      duelReady: 'ГОТОВ К БОЮ',
      duelReadyWait: 'ГОТОВ! ЖДЁМ СОПЕРНИКА…',
      duelReadyBadge: 'ГОТОВ',
      duelNotReady: 'НЕ ГОТОВ',
      duelFoeReady: 'СОПЕРНИК ГОТОВ — ЖМИ «ГОТОВ К БОЮ»!',
    ...
    en: {
      ...
      ghostWarn: 'A HUNTER!',
      ghostEat: 'HUNTER EATEN +{1}',
      ghostEaten: 'YOU WERE DEVOURED!',
      ...
      lobbyPickHint: 'PICK A PLAYER',
      quickBattle: 'QUICK BATTLE',
      duelFoeFound: 'RIVAL IN THE ROOM!',
      lobbyOnline: 'IN LOBBY NOW: {1}',
      duelRoomTitle: 'BATTLE ROOM',
      duelLeave: 'LEAVE ROOM',
      buildLabel: 'BUILD {1}',
      duelReady: 'READY TO FIGHT',
      duelReadyWait: 'READY! WAITING FOR THE RIVAL…',
      duelReadyBadge: 'READY',
      duelNotReady: 'NOT READY',
      duelFoeReady: 'RIVAL IS READY — PRESS READY!',
